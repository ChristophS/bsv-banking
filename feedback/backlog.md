...
## 1. Button-Text und Position beim Vorgangsanlegen aus Mail verbessern

**Priorität:** mittel

**Grund:** Separater kleiner UI-Punkt, aber nicht Teil des aktuellen Arbeitsfokus auf frische Transaktionskandidaten im Mail-Flow.
...
**Grund:** Großer Eingriff in Datenmodell, Zuordnungen, UI und Auswertungen; nicht klein genug für dieses kontrollierte Arbeitspaket.
...
## 3. Fehlbuchungs-Flow für Nullung mit Gegenbetrag und direktem Abschluss

**Priorität:** hoch

**Grund:** Eigenständiger fachlicher Sonderfall mit Abschlussvalidierung und Klassifikationsregeln; besser getrennt von diesem Kandidaten-Refresh-Paket.
...
## 4. Dashboard-Startseite mit anstehenden Terminen, To-Dos, offenen Vorgängen und Alles-synchronisieren

**Priorität:** mittel

**Grund:** Größeres Oberflächenthema mit mehreren Widgets und Startseitenstruktur; nicht Teil eines kleinen gezielten Fixes.
...
**Grund:** Größere Erweiterung der Zuordnungslogik zwischen Mail, Belegen, Vorgängen und Transaktionen; nicht klein genug für dieses Paket.
...
**Grund:** Neues größeres Modul mit erheblichem Konzeptionsbedarf; klar außerhalb des aktuellen kleinen Umsetzungspakets.
...
## 7. Unbekannte Transaktions-ID per HTTP zusätzlich testen

**Priorität:** niedrig

**Grund:** Nützliche zusätzliche Absicherung, aber unabhängig vom gewählten Fokus auf frische Kandidaten im Mail-Dialog.
