...
**Grund:** Separater Mail-/Dokumenten-Flow mit UI-Auswirkungen; nicht Teil dieses kleinen Sortierpakets.
...
**Grund:** UI-/UX-Verbesserung, aber nicht so dringlich wie arbeitskritische Funktionspunkte.
...
## 5. Manuelles To-Do-Anlegen auch ohne Vorschlag ermöglichen

**Priorität:** hoch

**Grund:** Kleines eigenes Paket im Vorgangsanlage-Flow, aber nicht das aktuell gewählte Backlog-Thema.
...
## 6. Aktuellste Transaktionen im mailbasierten Vorgangsanlegen verfügbar machen
...
## 7. Fehlbuchungs-Flow für Nullung mit Gegenbetrag und direktem Abschluss
...
## 8. Mail-Senden: Zeilenumbrüche erhalten und Empfängerauswahl ermöglichen
...
## 9. Dashboard-Startseite mit anstehenden Terminen, To-Dos, offenen Vorgängen und Alles-synchronisieren
