...
## 1. Split-Klassifikation und Statusableitung fachlich in Vorgänge integrieren
...
**Grund:** Nach dem einfachen Split-Editor ist der nächste fachliche Ausbauschritt die Klassifikation einzelner Splits und ihre Wirkung auf Vorgänge, ohne die bestehende Vorgangsarchitektur zu umgehen.
...
**Grund:** Der weiterführende Ausbau zu mehreren Rechnungen, Teilrechnungen und differenzierten Zuordnungsfällen ist ein späteres Teilpaket desselben Split-Epics.
...
**Grund:** Eigenständiger Mail-/Dokumenten-/Vorgangsflow mit separatem UI- und Zuordnungsworkflow; nicht Teil des Split-Epics.
...
**Grund:** Großes eigenständiges Modul mit erheblichem Konzeptions- und Integrationsaufwand außerhalb der aktuellen Finanz- und Split-Teilaufgabe.
