...
class DashboardHTTPTests(unittest.TestCase):
    ...
    def test_mail_import_invalid_inline_classification_has_no_partial_effects(self):
        self.server.data_store.update_transaction_classification(
            "tx_newer",
            {
                "transaktionstyp": "",
        ...
        self.assertEqual([], linked_payload["vorgaenge"])

        transaction = self.server.data_store.transaction_detail("tx_newer")
        self.assertEqual("", transaction["transaktionstyp"])
        self.assertEqual("", transaction["oberkategorie"])
        self.assertEqual("", transaction["unterkategorie"])
        self.assertEqual("", transaction["sphaere"])
        self.assertEqual("", transaction["fachliche_beschreibung"])
